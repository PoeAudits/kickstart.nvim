...
vim.keymap.set('n', '<leader>fp', '<cmd>!black %<CR>', { desc = 'Format current file using Black (python)' })
...
vim.keymap.set('n', 'yA+', 'gg0"+yG', { desc = 'Yank All to Clipboard' })
vim.keymap.set('n', 'yAp', 'gg0yG', { desc = 'Yank All to paste buffer' })
...
vim.keymap.set('n', '<C-f>', '<cmd>silent !tmux neww tmux-sessionizer<CR>', { desc = 'Use Tmux Sessionizer in new session' })
